...
with open('/content/drive/MyDrive/Colab Notebooks/data/reddit-comments-2015-08.csv', 'r') as f:
    reader = csv.reader(f, skipinitialspace=True)
    next(reader)
    # Split full comments into sentences
    # https://stackoverflow.com/questions/5239856/asterisk-in-function-call
    sentences = itertools.chain(*[nltk.sent_tokenize(row[0].lower()) for row in reader])
